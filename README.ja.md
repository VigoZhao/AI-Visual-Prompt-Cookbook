...
まずこの 6 つを見ると、ライブラリの幅がわかります。すべてのスタイルは 1 つの JSON と 2 枚のプレビュー画像で構成されています。73 種すべては下の [All Styles](#all-styles) ギャラリーで確認できます。
...
<p><a href="styles/jade-glyph-grocer-collage-poster-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/jade-glyph-grocer-collage-poster-style.md">プロンプトをコピー</a> · <a href="styles/jade-glyph-grocer-collage-poster-style">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/scarlet-court-photo-type-poster-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/scarlet-court-photo-type-poster-style.md">プロンプトをコピー</a> · <a href="styles/scarlet-court-photo-type-poster-style">フォルダ</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/sunlit-kinetic-block-type-photo-poster-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/sunlit-kinetic-block-type-photo-poster-style.md">プロンプトをコピー</a> · <a href="styles/sunlit-kinetic-block-type-photo-poster-style">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/scarlet-block-cutout-doodle-book-cover-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/scarlet-block-cutout-doodle-book-cover-style.md">プロンプトをコピー</a> · <a href="styles/scarlet-block-cutout-doodle-book-cover-style">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p>見える素材を別の象徴的なシルエットに組み替え、古びたクリーム紙に青緑のハーフトーンで刷る、余白の多いレトロPSAポスターシステム。</p>
<p><a href="styles/halftone-assemblage-metaphor-psa-poster-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/halftone-assemblage-metaphor-psa-poster-style.md">プロンプトをコピー</a> · <a href="styles/halftone-assemblage-metaphor-psa-poster-style">フォルダ</a></p>
</td>
</tr>
</table>
