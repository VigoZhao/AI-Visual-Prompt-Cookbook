...
まずこの 6 つを見ると、ライブラリの幅がわかります。すべてのスタイルは 1 つの JSON と 2 枚のプレビュー画像で構成されています。68 種すべては下の [All Styles](#all-styles) ギャラリーで確認できます。
...
<p>暖かな教室の方眼紙、縦書きの手描きノート、大きな中央の破り紙コラージュを、実物紙の浅い影で見せるノスタルジックなポスターシステム。</p>
<p><a href="styles/school-grid-paper-cutout-poster/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/school-grid-paper-cutout-poster.md">プロンプトをコピー</a> · <a href="styles/school-grid-paper-cutout-poster">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p>太い黒マーカーの輪郭、粗いクレヨン風パステル塗り、クリーム色の紙粒子、巨大で間の抜けたクリーチャー形状、分厚い手描き黒文字で作る素朴な子ども向けポスターシステム。</p>
<p><a href="styles/rough-marker-monster-poster-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/rough-marker-monster-poster-style.md">コピー用プロンプト</a> · <a href="styles/rough-marker-monster-poster-style">フォルダ</a></p>
</td>
</tr>
</table>
