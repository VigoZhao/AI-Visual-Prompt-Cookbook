...
이 6개 스타일로 시작하면 라이브러리의 범위를 빠르게 이해할 수 있습니다. 모든 스타일은 JSON 하나와 미리보기 이미지 두 장으로 구성됩니다. 전체 105개는 아래 [All Styles](#all-styles) 갤러리에서 볼 수 있습니다.
...
<p><a href="styles/surreal-megatype-dossier-collage/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/surreal-megatype-dossier-collage.md">프롬프트 복사</a> · <a href="styles/surreal-megatype-dossier-collage">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/urban-photo-ink-beast-collage-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/urban-photo-ink-beast-collage-style.md">프롬프트 복사</a> · <a href="styles/urban-photo-ink-beast-collage-style">폴더</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/prismatic-glass-animal-weekend-editorial/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/prismatic-glass-animal-weekend-editorial.md">프롬프트 복사</a> · <a href="styles/prismatic-glass-animal-weekend-editorial">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/sun-faded-scenic-editorial-poster/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/sun-faded-scenic-editorial-poster.md">프롬프트 복사</a> · <a href="styles/sun-faded-scenic-editorial-poster">폴더</a></p>
</td>
<td width="33%" valign="top">
