...
이 6개 스타일로 시작하면 라이브러리의 범위를 빠르게 이해할 수 있습니다. 모든 스타일은 JSON 하나와 미리보기 이미지 두 장으로 구성됩니다. 전체 73개는 아래 [All Styles](#all-styles) 갤러리에서 볼 수 있습니다.
...
<p><a href="styles/loose-scribble-riso-print-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/loose-scribble-riso-print-style.md">프롬프트 복사</a> · <a href="styles/loose-scribble-riso-print-style">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/jade-glyph-grocer-collage-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/jade-glyph-grocer-collage-poster-style.md">프롬프트 복사</a> · <a href="styles/jade-glyph-grocer-collage-poster-style">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/scarlet-court-photo-type-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/scarlet-court-photo-type-poster-style.md">프롬프트 복사</a> · <a href="styles/scarlet-court-photo-type-poster-style">폴더</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/sunlit-kinetic-block-type-photo-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/sunlit-kinetic-block-type-photo-poster-style.md">프롬프트 복사</a> · <a href="styles/sunlit-kinetic-block-type-photo-poster-style">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/scarlet-block-cutout-doodle-book-cover-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/scarlet-block-cutout-doodle-book-cover-style.md">프롬프트 복사</a> · <a href="styles/scarlet-block-cutout-doodle-book-cover-style">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p>한 종류의 재료를 다른 상징적 실루엣으로 배열하고 오래된 크림색 종이에 청록 하프톤으로 인쇄한 듯한, 간결한 레트로 PSA 포스터 시스템입니다.</p>
<p><a href="styles/halftone-assemblage-metaphor-psa-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/halftone-assemblage-metaphor-psa-poster-style.md">프롬프트 복사</a> · <a href="styles/halftone-assemblage-metaphor-psa-poster-style">폴더</a></p>
</td>
</tr>
</table>
