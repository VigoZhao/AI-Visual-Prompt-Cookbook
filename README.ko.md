...
이 6개 스타일로 시작하면 라이브러리의 범위를 빠르게 이해할 수 있습니다. 모든 스타일은 JSON 하나와 미리보기 이미지 두 장으로 구성됩니다. 전체 89개는 아래 [All Styles](#all-styles) 갤러리에서 볼 수 있습니다.
...
<p><a href="styles/scarlet-megatype-action-collage-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/scarlet-megatype-action-collage-style.md">프롬프트 복사</a> · <a href="styles/scarlet-megatype-action-collage-style">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/jagged-red-street-photo-event-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/jagged-red-street-photo-event-poster-style.md">프롬프트 복사</a> · <a href="styles/jagged-red-street-photo-event-poster-style">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/neon-stadium-3d-hero-type-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/neon-stadium-3d-hero-type-poster-style.md">프롬프트 복사</a> · <a href="styles/neon-stadium-3d-hero-type-poster-style">폴더</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/dusk-cyan-layered-type-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/dusk-cyan-layered-type-poster-style.md">프롬프트 복사</a> · <a href="styles/dusk-cyan-layered-type-poster-style">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/electric-blue-cutout-manga-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/electric-blue-cutout-manga-poster-style.md">프롬프트 복사</a> · <a href="styles/electric-blue-cutout-manga-poster-style">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/y2k-streetwear-sticker-collage-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/y2k-streetwear-sticker-collage-style.md">프롬프트 복사</a> · <a href="styles/y2k-streetwear-sticker-collage-style">폴더</a></p>
</td>
</tr>
</table>
