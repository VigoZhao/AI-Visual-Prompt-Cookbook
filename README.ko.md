...
이 6개 스타일로 시작하면 라이브러리의 범위를 빠르게 이해할 수 있습니다. 모든 스타일은 JSON 하나와 미리보기 이미지 두 장으로 구성됩니다. 전체 91개는 아래 [All Styles](#all-styles) 갤러리에서 볼 수 있습니다.
...
<p><a href="styles/red-black-manga-tabloid-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/red-black-manga-tabloid-poster-style.md">프롬프트 복사</a> · <a href="styles/red-black-manga-tabloid-poster-style">폴더</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/ice-cyan-megatype-action-poster-style/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/ice-cyan-megatype-action-poster-style.md">프롬프트 복사</a> · <a href="styles/ice-cyan-megatype-action-poster-style">폴더</a></p>
</td>
<td width="33%" valign="top">
