...
<p align="center">
  <img alt="风格数量" src="https://img.shields.io/badge/styles-61-ff5a7a?style=flat-square">
  <img alt="预览图" src="https://img.shields.io/badge/previews-122-4cc9f0?style=flat-square">
...
先看这 6 个风格。每个风格都保持轻量：一个 JSON 加两张预览图。完整 61 个风格见下面的 [All Styles](#all-styles) 画廊。
...
<p>一种折叠大报广告风格：米白新闻纸质感、密集双语编辑栏、超大商业产品摄影、黑色与古金色标题、倾斜印章框、红色日期条和可触摸的印刷旧化。</p>
<p><a href="styles/folded-newspaper-product-ad-style/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/folded-newspaper-product-ad-style.md">复制提示词</a> · <a href="styles/folded-newspaper-product-ad-style">目录</a></p>
</td>
<td width="33%" valign="top">
...
<p>一种温暖的模拟感时尚编辑海报风格：户外超模摄影、丰富前景质感、小型材质名牌细节，以及干净白色下三分之一标题和说明文字。</p>
<p><a href="styles/sunlit-supermodel-nameplate-editorial/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/sunlit-supermodel-nameplate-editorial.md">复制提示词</a> · <a href="styles/sunlit-supermodel-nameplate-editorial">目录</a></p>
</td>
</tr>
</table>
