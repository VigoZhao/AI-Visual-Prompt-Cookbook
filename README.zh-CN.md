...
<p align="center">
  <img alt="风格数量" src="https://img.shields.io/badge/styles-68-ff5a7a?style=flat-square">
  <img alt="预览图" src="https://img.shields.io/badge/previews-136-4cc9f0?style=flat-square">
...
先看这 6 个风格。每个风格都保持轻量：一个 JSON 加两张预览图。完整 68 个风格见下面的 [All Styles](#all-styles) 画廊。
...
<p>一种稀疏复古公益海报系统：把一类可见材料排列成另一种可识别的象征剪影，用蓝绿色网点印刷在老米色纸张上，并搭配紧凑的红色与海军蓝宣传字体。</p>
<p><a href="styles/halftone-assemblage-metaphor-psa-poster-style/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/halftone-assemblage-metaphor-psa-poster-style.md">复制提示词</a> · <a href="styles/halftone-assemblage-metaphor-psa-poster-style">目录</a></p>
</td>
<td width="33%" valign="top">
...
<h3>School Grid Paper Cutout Poster</h3>
<p>一种稀疏怀旧海报系统：温暖课堂方格纸、手写竖向笔记，以及一个大型居中撕纸拼贴物件，配合真实纸张的浅阴影。</p>
<p><a href="styles/school-grid-paper-cutout-poster/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/school-grid-paper-cutout-poster.md">复制提示词</a> · <a href="styles/school-grid-paper-cutout-poster">目录</a></p>
</td>
<td width="33%" valign="top">
...
<p>一种竖向手绘荒诞语录卡海报系统：粗糙黑色马克笔轮廓、浅粉彩面板、块状蓝色字形、歪斜标签页，以及一个简单中心物件角色笑点，整体是扁平稚拙插画。</p>
<p><a href="styles/naive-marker-quote-card-style/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/naive-marker-quote-card-style.md">复制提示词</a> · <a href="styles/naive-marker-quote-card-style">目录</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p>一种稚拙扁平海报系统：完整天蓝色画面、粗糙房屋形白色内框、巨大不均匀黑色手写字、小徽章标签，以及像马克笔涂鸦一样绘制的简单粗描边卡通家居生活场景。</p>
<p><a href="styles/sky-blue-home-life-doodle-poster-style/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/sky-blue-home-life-doodle-poster-style.md">复制提示词</a> · <a href="styles/sky-blue-home-life-doodle-poster-style">目录</a></p>
</td>
<td width="33%" valign="top">
...
<p>一种稚拙手绘海报风格：米色纸张边距、松散马克笔涂写色块、粗厚不均匀关键线、超大休闲手写字，以及按清晰公益海报层级排布的简单吉祥物式人物。</p>
<p><a href="styles/playful-marker-grounding-poster-style/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/playful-marker-grounding-poster-style.md">复制提示词</a> · <a href="styles/playful-marker-grounding-poster-style">目录</a></p>
</td>
<td width="33%" valign="top">
...
<h3>Rough Marker Monster Poster Style</h3>
<p>一种童趣怪物海报系统：厚重黑色马克笔轮廓、粗糙蜡笔粉彩填色、米色纸张颗粒、夸张搞怪生物形态，以及粗壮手写黑色文字。</p>
<p><a href="styles/rough-marker-monster-poster-style/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/rough-marker-monster-poster-style.md">复制提示词</a> · <a href="styles/rough-marker-monster-poster-style">目录</a></p>
</td>
</tr>
</table>
