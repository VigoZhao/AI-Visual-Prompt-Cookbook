...
<p><a href="styles/acid-jolt-photo-collage/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/acid-jolt-photo-collage.md">复制提示词</a> · <a href="styles/acid-jolt-photo-collage">目录</a></p>
</td>
<td width="33%" valign="top">
...
<p>An intimate sports photograph captures one bodily state through moody warm light, deep natural shadow and pronounced selective focus. A prominent white original logo and tight two-line wordmark overlap the optical center of the photograph.</p>
<p><a href="styles/felt-motion-brand-campaign-set-02/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/felt-motion-brand-campaign-set-02.md">复制提示词</a> · <a href="styles/felt-motion-brand-campaign-set-02">目录</a></p>
</td>
<td width="33%" valign="top">
