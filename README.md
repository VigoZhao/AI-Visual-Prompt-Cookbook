...
Six visual systems to start with. Every style ships as one JSON plus two preview images. Browse the complete set of 85 in the [All Styles](#all-styles) gallery below.
...
<p><a href="styles/monochrome-xerox-sports-dossier/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/monochrome-xerox-sports-dossier.md">Copy Prompt</a> · <a href="styles/monochrome-xerox-sports-dossier">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/liquid-chrome-clearance-poster-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/liquid-chrome-clearance-poster-style.md">Copy Prompt</a> · <a href="styles/liquid-chrome-clearance-poster-style">Folder</a></p>
</td>
</tr>
</table>
