...
<p align="center">
  <img alt="Styles" src="https://img.shields.io/badge/styles-96-ff5a7a?style=flat-square">
  <img alt="Previews" src="https://img.shields.io/badge/previews-192-4cc9f0?style=flat-square">
...
Six visual systems to start with. Every style ships as one JSON plus two preview images. Browse the complete set of 96 in the [All Styles](#all-styles) gallery below.
