...
Six visual systems to start with. Every style ships as one JSON plus two preview images. Browse the complete set of 74 in the [All Styles](#all-styles) gallery below.
...
<p><a href="styles/neon-type-photo-scribble-poster/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/neon-type-photo-scribble-poster.md">Copy Prompt</a> · <a href="styles/neon-type-photo-scribble-poster">Folder</a></p>
</td>
<td width="33%" valign="top">
