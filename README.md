...
Six visual systems to start with. Every style ships as one JSON plus two preview images. Browse the complete set of 80 in the [All Styles](#all-styles) gallery below.
...
<p><a href="styles/monochrome-grid-sneaker-tech-spec/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/monochrome-grid-sneaker-tech-spec.md">Copy Prompt</a> · <a href="styles/monochrome-grid-sneaker-tech-spec">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/sky-blue-lucky-tag-doodle-poster-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/sky-blue-lucky-tag-doodle-poster-style.md">Copy Prompt</a> · <a href="styles/sky-blue-lucky-tag-doodle-poster-style">Folder</a></p>
</td>
</tr>
</table>
