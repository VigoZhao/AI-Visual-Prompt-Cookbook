...
Six visual systems to start with. Every style ships as one JSON plus two preview images. Browse the complete set of 89 in the [All Styles](#all-styles) gallery below.
...
<p><a href="styles/scarlet-megatype-action-collage-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/scarlet-megatype-action-collage-style.md">Copy Prompt</a> · <a href="styles/scarlet-megatype-action-collage-style">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/jagged-red-street-photo-event-poster-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/jagged-red-street-photo-event-poster-style.md">Copy Prompt</a> · <a href="styles/jagged-red-street-photo-event-poster-style">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/neon-stadium-3d-hero-type-poster-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/neon-stadium-3d-hero-type-poster-style.md">Copy Prompt</a> · <a href="styles/neon-stadium-3d-hero-type-poster-style">Folder</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/dusk-cyan-layered-type-poster-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/dusk-cyan-layered-type-poster-style.md">Copy Prompt</a> · <a href="styles/dusk-cyan-layered-type-poster-style">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/electric-blue-cutout-manga-poster-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/electric-blue-cutout-manga-poster-style.md">Copy Prompt</a> · <a href="styles/electric-blue-cutout-manga-poster-style">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/y2k-streetwear-sticker-collage-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/y2k-streetwear-sticker-collage-style.md">Copy Prompt</a> · <a href="styles/y2k-streetwear-sticker-collage-style">Folder</a></p>
</td>
</tr>
</table>
