...
Six visual systems to start with. Every style ships as one JSON plus two preview images. Browse the complete set of 91 in the [All Styles](#all-styles) gallery below.
...
<p><a href="styles/red-black-manga-tabloid-poster-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/red-black-manga-tabloid-poster-style.md">Copy Prompt</a> · <a href="styles/red-black-manga-tabloid-poster-style">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/ice-cyan-megatype-action-poster-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/ice-cyan-megatype-action-poster-style.md">Copy Prompt</a> · <a href="styles/ice-cyan-megatype-action-poster-style">Folder</a></p>
</td>
<td width="33%" valign="top">
