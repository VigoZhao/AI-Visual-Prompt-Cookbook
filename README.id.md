...
Enam sistem visual ini cocok untuk memulai. Setiap gaya berisi satu JSON dan dua gambar preview. Jelajahi 68 gaya lengkap di galeri [All Styles](#all-styles) di bawah.
...
<p>Sistem poster nostalgia yang memakai kertas grid kelas, tulisan tangan vertikal, dan satu objek kolase kertas robek besar dengan bayangan kertas fisik yang lembut.</p>
<p><a href="styles/school-grid-paper-cutout-poster/style.json"><strong>Buka style.json</strong></a> · <a href="docs/copy-prompts/school-grid-paper-cutout-poster.md">Salin Prompt</a> · <a href="styles/school-grid-paper-cutout-poster">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p>Sistem poster anak-anak yang naif dengan outline marker hitam tebal, isian warna krayon-pastel kasar, grain kertas krem, bentuk makhluk lucu berukuran besar, dan teks hitam hand-lettered yang chunky.</p>
<p><a href="styles/rough-marker-monster-poster-style/style.json"><strong>Buka style.json</strong></a> · <a href="docs/copy-prompts/rough-marker-monster-poster-style.md">Salin Prompt</a> · <a href="styles/rough-marker-monster-poster-style">Folder</a></p>
</td>
</tr>
</table>
...
Jelajahi semua 68 gaya di bawah.
