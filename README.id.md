...
<p align="center">
  <img alt="Styles" src="https://img.shields.io/badge/styles-85-ff5a7a?style=flat-square">
  <img alt="Previews" src="https://img.shields.io/badge/previews-170-4cc9f0?style=flat-square">
...
Enam sistem visual ini cocok untuk memulai. Setiap gaya berisi satu JSON dan dua gambar preview. Jelajahi 85 gaya lengkap di galeri [All Styles](#all-styles) di bawah.
...
<h3>Monochrome Xerox Sports Dossier</h3>
<p>A black-and-white photocopied editorial collage system with oversized cropped subjects, overlapping inset photo panels, huge distressed condensed type, micro dossier labels, paper grain, halftone, scratches, and a sparse sports-press-kit mood.</p>
<p><a href="styles/monochrome-xerox-sports-dossier/style.json"><strong>Buka style.json</strong></a> · <a href="docs/copy-prompts/monochrome-xerox-sports-dossier.md">Salin Prompt</a> · <a href="styles/monochrome-xerox-sports-dossier">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/liquid-chrome-clearance-poster-style/style.json"><strong>Buka style.json</strong></a> · <a href="docs/copy-prompts/liquid-chrome-clearance-poster-style.md">Salin Prompt</a> · <a href="styles/liquid-chrome-clearance-poster-style">Folder</a></p>
</td>
</tr>
</table>
...
Jelajahi semua 85 gaya di bawah.
