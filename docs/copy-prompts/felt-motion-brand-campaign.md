...
![Felt Motion Brand Campaign preview](../../styles/felt-motion-brand-campaign/preview-16x9.jpg)
...
Default case: `signal-in-the-static`

```text
Use the "Felt Motion Brand Campaign" visual style as the locked style.

Create a 16:9 image.

Subject: an adult male road cyclist with short dark curls, an off-white vented helmet and a nearly black cycling jersey, against clear blue sky
...
- [Open style.json](../../styles/felt-motion-brand-campaign/style.json)
- [Open style folder](../../styles/felt-motion-brand-campaign/)
