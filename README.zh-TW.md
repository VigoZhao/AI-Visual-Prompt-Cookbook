...
<p>一種折疊大報廣告風格：米白新聞紙質感、密集雙語編輯欄、超大商業產品攝影、黑色與古金色標題、傾斜印章框、紅色日期條和可觸摸的印刷舊化。</p>
<p><a href="styles/folded-newspaper-product-ad-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/folded-newspaper-product-ad-style.md">複製提示詞</a> · <a href="styles/folded-newspaper-product-ad-style">目錄</a></p>
</td>
<td width="33%" valign="top">
