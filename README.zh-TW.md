...
<p align="center">
  <img alt="風格數量" src="https://img.shields.io/badge/styles-73-ff5a7a?style=flat-square">
  <img alt="預覽圖" src="https://img.shields.io/badge/previews-146-4cc9f0?style=flat-square">
...
先看這 6 個風格。每個風格都保持輕量：一個 JSON 加兩張預覽圖。完整 73 個風格見下面的 [All Styles](#all-styles) 畫廊。
...
<p><a href="styles/jade-glyph-grocer-collage-poster-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/jade-glyph-grocer-collage-poster-style.md">複製提示詞</a> · <a href="styles/jade-glyph-grocer-collage-poster-style">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/scarlet-court-photo-type-poster-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/scarlet-court-photo-type-poster-style.md">複製提示詞</a> · <a href="styles/scarlet-court-photo-type-poster-style">目錄</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p><a href="styles/sunlit-kinetic-block-type-photo-poster-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/sunlit-kinetic-block-type-photo-poster-style.md">複製提示詞</a> · <a href="styles/sunlit-kinetic-block-type-photo-poster-style">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p><a href="styles/scarlet-block-cutout-doodle-book-cover-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/scarlet-block-cutout-doodle-book-cover-style.md">複製提示詞</a> · <a href="styles/scarlet-block-cutout-doodle-book-cover-style">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p>一種稀疏復古公益海報系統：把一類可見材料排列成另一種可識別的象徵剪影，用藍綠色網點印刷在老米色紙張上，並搭配緊湊的紅色與海軍藍宣傳字體。</p>
<p><a href="styles/halftone-assemblage-metaphor-psa-poster-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/halftone-assemblage-metaphor-psa-poster-style.md">複製提示詞</a> · <a href="styles/halftone-assemblage-metaphor-psa-poster-style">目錄</a></p>
</td>
</tr>
</table>
