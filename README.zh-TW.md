...
<p>一種平面插畫海報系統：飽和青色背景、超大紅色塊狀字、檸檬黃人物點綴、白色鋸齒衝擊波、粗紅描邊和緊湊旋轉微文案，像地方旅行海報混合漫畫衝擊圖形與網版印刷街頭標牌。</p>
<p><a href="styles/cyan-red-shockwave-type-poster-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/cyan-red-shockwave-type-poster-style.md">複製提示詞</a> · <a href="styles/cyan-red-shockwave-type-poster-style">目錄</a></p>
</td>
<td width="33%" valign="top">
