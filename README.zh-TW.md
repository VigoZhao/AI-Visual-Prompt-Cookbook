...
<p align="center">
  <img alt="風格數量" src="https://img.shields.io/badge/styles-68-ff5a7a?style=flat-square">
  <img alt="預覽圖" src="https://img.shields.io/badge/previews-136-4cc9f0?style=flat-square">
...
先看這 6 個風格。每個風格都保持輕量：一個 JSON 加兩張預覽圖。完整 68 個風格見下面的 [All Styles](#all-styles) 畫廊。
...
<p>一種稀疏懷舊海報系統：溫暖課堂方格紙、手寫直向筆記，以及一個大型置中的撕紙拼貼物件，配合真實紙張的淺陰影。</p>
<p><a href="styles/school-grid-paper-cutout-poster/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/school-grid-paper-cutout-poster.md">複製提示詞</a> · <a href="styles/school-grid-paper-cutout-poster">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p>一種童趣怪物海報系統：厚重黑色麥克筆輪廓、粗糙蠟筆粉彩填色、米色紙張顆粒、誇張搞怪生物形態，以及粗壯手寫黑色文字。</p>
<p><a href="styles/rough-marker-monster-poster-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/rough-marker-monster-poster-style.md">複製提示詞</a> · <a href="styles/rough-marker-monster-poster-style">目錄</a></p>
</td>
</tr>
</table>
